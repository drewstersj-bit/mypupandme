          ...
          <div className="container container--narrow">
            ...
            <div className="size-guide-page__illustration">
              <svg viewBox="0 0 300 200" width="300" height="200" aria-label="Illustration showing measurement points on a small dog" role="img">
                ...
                <path d="M135 100c15 8 20 25 20 30" fill="none" stroke="#E63946" strokeWidth="2.5" strokeDasharray="6 3"/>
                <ellipse cx="150" cy="130" rx="70" ry="40" fill="none" stroke="#E63946" strokeWidth="2.5" strokeDasharray="6 3"/>
