...
const pages: PageMeta[] = [
  ...
  },
  {
    ...
    title: 'What Makes a Good Harness for a Toy Breed? | My Pup and Me',
    description: 'Why toy breeds need harnesses built for their size — not just scaled-down versions of larger products. Key features that make a genuine difference.',
